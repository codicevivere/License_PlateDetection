...
class CrtFeatures():    
    ...
    def __init__(self):
        ...
        self.trn_path = [self.conf['DataSet_LP'],self.conf['DataSet_NLP']]
    ...
    def create_dataset_features(self, store=None):
        # print (self.trn_path)
        feature_dataset, labels_dataset = self.create_features(self.trn_path)     # Prepare the training dataset
        self.features = np.array(feature_dataset, dtype="float64")
        self.labels = np.array(labels_dataset)
